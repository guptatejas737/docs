...
Reference the following code into your project to start right away.
...
Parameters often set when initializing the `Smallest` or `AsyncSmallest` instance.
...
<Note>
  **Any questions or suggestions?** Raise an issue on [Github](https://github.com/smallest-inc/smallest-python-sdk), Join our [Discord](https://discord.com/invite/5evETqguJs), or email [support@smallest.ai](mailto:support@smallest.ai)
</Note>